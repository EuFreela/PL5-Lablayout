...
<p>A ideia deste plugin é simples e eficaz. Ao instalar em seus clientes a versão escolhida, para atualização do layout das alicações de seus clientes, basta uma atualização do plugin ou releases. COm um simples comando composer, toda o layout da aplicação é atualizado como num passe de mágica.</p>
